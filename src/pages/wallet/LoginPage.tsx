...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-bg dark:bg-bg flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-bold text-primary dark:text-dark-primary">Wallet</h1>
          <p className="text-sm text-muted dark:text-dark-muted mt-2">Quản lý chi tiêu thông minh</p>
        </div>

        {/* Login button */}
        <Button variant="accent" className="w-full" onClick={handleGoogleLogin}>
